Shader "Unlit/S_BGUI_Tr"
{
    Properties
    {
        [NoScaleOffset]_MainTex("_MainTex", 2D) = "white" {}
        _TilingX("TilingX", Range(0.3, 2)) = 1
        _TilingY("TilingY", Range(0.3, 2)) = 1
        ...
        SubShader
    {
        ...
        SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
        {
            ...
            float4 _Multiply_69ee9818a29742d0a2f015aaff047248_Out_2;
            Unity_Multiply_float4_float4(_SampleTexture2D_1148cf232a7d47ed94264ec5b3790bfc_RGBA_0, (_SampleTexture2D_1148cf232a7d47ed94264ec5b3790bfc_A_7.xxxx), _Multiply_69ee9818a29742d0a2f015aaff047248_Out_2);
            float _Property_2e50ef3f07974e938bc91e4cc1bd3719_Out_0 = _Alpha;
            float _Multiply_a5a70bf084ea4de1a90f10188c3ceb15_Out_2;
            Unity_Multiply_float_float(_SampleTexture2D_1148cf232a7d47ed94264ec5b3790bfc_A_7, _Property_2e50ef3f07974e938bc91e4cc1bd3719_Out_0, _Multiply_a5a70bf084ea4de1a90f10188c3ceb15_Out_2);
            surface.BaseColor = (_Multiply_69ee9818a29742d0a2f015aaff047248_Out_2.xyz);
            surface.Alpha = _Multiply_a5a70bf084ea4de1a90f10188c3ceb15_Out_2;
            return surface;
        }
