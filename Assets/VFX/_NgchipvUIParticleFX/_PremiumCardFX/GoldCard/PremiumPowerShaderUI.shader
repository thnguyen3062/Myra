Shader "PremiumPowerShader"
{
    Properties
    {
        [HDR] Color_3a77e5b24bf345409e3fa5c6da2b2eb7("Color1", Color) = (1, 0.703978, 0, 1)
        ...
        Vector1_edd494cc0e384b538c7f81874429d4ac("Opacity", Range(0, 1)) = 1
...
float Vector1_edd494cc0e384b538c7f81874429d4ac;
CBUFFER_END
...
SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
{
    ...
    float _Property_bdebb53280a24ff9a7759f71ac6f9b8e_Out_0 = Vector1_edd494cc0e384b538c7f81874429d4ac;
    ...
    float _Multiply_68e172d68d164474868dc957ec739f64_Out_2;
    Unity_Multiply_float(_Property_bdebb53280a24ff9a7759f71ac6f9b8e_Out_0, _Multiply_2f3d4794b48d44a39fe60c46d978bea9_Out_2, _Multiply_68e172d68d164474868dc957ec739f64_Out_2);
    surface.BaseColor = (_Add_9158d274bb394d8eaaf68405d1838517_Out_2.xyz);
    surface.Alpha = _Multiply_68e172d68d164474868dc957ec739f64_Out_2;
    return surface;
}
